...
class ProjectItem extends Component {
    ...
    renderFile() {
        if (this.state.documentHref != '') {
            var abc = require('../files/' + this.state.documentHref);
            ...
            <div className="container">
                ...
                <div>
                    ...
                    <div className='row'>
                            ...
                            <div className="row mt-3 ml-5">
                                <div className="col-xs-12 col-sm-12 col-md-6 col-lg-6 " >
                                    <div className="panel panel-info">
                                        ...
                                        <div>
                                            <div>
                                                {this.bidNow()}                                                <div className="mt-4 ml-5">
                        ...
                        <div className='col md-6 mt-5' hide='true'>
                            {this.bidNowForm()}
                        </div>
                    ...
                    <div>  <div className="content-wrapper">
                        <ol className="breadcrumb mt-2">
                            ...
                            <li className="breadcrumb-item active">Project Bids</li>
                        </ol>
                    </div>
                        <ProjectBidDetail />
                    </div>
